<div class="container mx-auto p-3">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-xl overflow-hidden h-fit">
            ...
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-xl overflow-hidden">
                ...
                <div class="p-5">
                    ...
                    <form id="testMailForm" class="space-y-4">
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="text-[11px] font-medium text-zinc-400 uppercase tracking-widest">Subject</label>
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="text-[11px] font-medium text-zinc-400 uppercase tracking-widest">Message</label>
