...
<div class="flex gap-2 mb-4">
    <input type="text" id="{{ $id }}SearchInput" placeholder="{{ $placeholder }}"
        class="w-full max-w-xs rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:border-orange-500 focus:ring-orange-500">
    <button type="button" id="{{ $id }}SearchBtn"
        class="inline-flex items-center gap-1.5 rounded-lg border border-zinc-300 px-3.5 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50">
